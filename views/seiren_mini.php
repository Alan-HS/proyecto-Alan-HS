...
<head>
    ...
    <title>Seiren Mini</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/seirenmini_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Razer Seiren Mini</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo micrófono de Razer podrás tener un increíble audio de voz gracias a su capacidad de grabación profesional, además de ser compacto y portátil para tener comodidad en tú día a día y una excelente experiencia.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Compacto y portatil</span>
            <span id="caracteristica2" style="display: none;">Capacidad de grabación profesional</span>
            <span id="caracteristica3" style="display: none;">Conectividad USB</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/seirenmini_1.png</span>
