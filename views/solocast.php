...
<head>
    ...
    <title>HyperX Solocast</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/solocast_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">HyperX Solocast</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo micrófono de HyperX podrás tener un increíble audio de voz gracias a su conexión Plug & Play, además de tener sensor de silencio con indicador LED para tener comodidad en tú día a día y una excelente experiencia.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Grabación de audio Plug & Play</span>
            <span id="caracteristica2" style="display: none;">Sensor de silencio con indicador LED</span>
            <span id="caracteristica3" style="display: none;">Soporte flexible y ajustable</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/solocast_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">1200</span> <!-- Cambiar esto a cada una -->
