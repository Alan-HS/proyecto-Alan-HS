...
<head>
    ...
    <title>Dreamcatcher Lightstick</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/lightdreamcatcher_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Dreamcatcher Lightstick</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo lightstick de Dreamcatcher podrás tener una increíble experiencia en los conciertos gracias a su autonomía de batería, además de tener iluminación RGB para poder apoyar a tu grupo favorito con estilo.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Batería de 2000 mAh</span>
            <span id="caracteristica2" style="display: none;">Capacidad para alargar su tamaño</span>
            <span id="caracteristica3" style="display: none;">Iluminación RGB</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/lightdreamcatcher_1.png</span>
