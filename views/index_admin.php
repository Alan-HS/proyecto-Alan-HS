...
<body>
    <div class="header">
        <div class="logo">
            <a href="index_admin.html"><img class="img-logo" src="10.png" alt="LOGO"></a>
        </div>
        <div class="cart-icon">
    ...
    <div class="best-sellers">
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="2.png" alt="Imagen producto mejor vendido"></a>
            <h2 class="name-product">Logitech G300s</h2>
        </div>
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="3.png" alt="Imagen producto mejor vendido"></a>
            <h2 class="name-product">Formula of Love: O+T=&lt3</h2>
        </div>
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="4.png" alt="Imagen producto mejor vendido"></a>
            <h2 class="name-product">Razer Seiren Mini</h2>
        </div>
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="5.png" alt="Imagen producto mejor vendido"></a>
            <h2 class="name-product">Lightstick Dreamcatcher</h2>
        </div>
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="6.png" alt="Imagen producto mejor vendido"></a>
            <h2 class="name-product">Photocard Moonbyul</h2>
        </div>
        <div class="product">
            <a href="product_admin.html"><img class="img-product" src="7.png" alt="Imagen producto mejor vendido"></a>
