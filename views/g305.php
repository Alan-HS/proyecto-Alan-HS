...
<head>
    ...
    <title>G305</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/g305_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">G305 K/DA EDITION</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo mouse de Logitech podrás lograr cosas increíbles gracias a su sensor HERO de 12000 DPI, además de poder tener la capacidad de ser inalámbrico para decirle adiós a los cables y mejor movilidad.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Sensor HERO de 12,000 DPI</span>
            <span id="caracteristica2" style="display: none;">6 botones programables</span>
            <span id="caracteristica3" style="display: none;">Duración de hasta 250 horas</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/g305_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">800</span> <!-- Cambiar esto a cada una -->
