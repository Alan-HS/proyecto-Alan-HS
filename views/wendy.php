...
<head>
    ...
    <title>Photocard Wendy</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/wendy_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Wendy Photocard</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con la nueva photocard de Wendy podrás tener un increíble objeto de colección gracias a que es original y es importado desde corea del sur, además de ser pequeño, edición especial de invierno y con buena calidad de materiales para que puedas tener una fotografía de ese artista que tanto adoras.
            </p>
