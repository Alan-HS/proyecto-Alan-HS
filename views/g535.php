...
<head>
    ...
    <title>G535</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/g535_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">G535</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo headset de Logitech podrás tener un increíble sonido gracias a sus altavoces de 40 mm, además de poder tener la capacidad de ser compatible con PC y consolas para tener comodidad en tu día a día.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Conexión Plug and Play</span>
            <span id="caracteristica2" style="display: none;">Altavoces de 40 mm</span>
            <span id="caracteristica3" style="display: none;">Compatible con PC y consolas</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/g535_1.png</span>
