...
<head>
    ...
    <title>Cloud Flight S</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/flights_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">HyperX Cloud Flight S</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo headset de HyperX podrás tener un increíble sonido gracias a su sonido envolvente 7.1, además de poder tener la capacidad de ser inalámbrico y con buena duración de batería para tener comodidad en tu día a día.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Conexión inalámbrica de 2.4 GHz</span>
            <span id="caracteristica2" style="display: none;">Batería con duración de hasta 30 horas</span>
            <span id="caracteristica3" style="display: none;">Sonido envolvente 7.1</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/flights_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">3000</span> <!-- Cambiar esto a cada una -->
