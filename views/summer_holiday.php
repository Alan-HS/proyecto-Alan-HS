...
<head>
    ...
    <title>Summer Holiday</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/summerholiday_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Dreamcatcher Summer Holiday</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo álbum de Dreamcatcher podrás tener una increíble experiencia de audio gracias a sus 6 canciones, además de tener un photobook para que puedas observar el detrás de cámaras de este último lanzamiento.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Contiene 6 canciones</span>
            <span id="caracteristica2" style="display: none;">Contiene 1 photocard al azar de 7</span>
            ...
            <span id="srcimg" style="display: none;">../images/summerholiday_1.png</span>
