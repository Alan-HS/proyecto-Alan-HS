...
<head>
    ...
    <title>HyperX Quadcast</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/quadcast_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">HyperX Quadcast</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo micrófono de HyperX podrás tener un increíble audio de voz gracias a su ajuste de control de ganancias, además de tener un montaje anti vibración para tener comodidad en tú día a día y una excelente experiencia.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Montaje antivibración</span>
            <span id="caracteristica2" style="display: none;">Sensor de encendido a silencio</span>
            <span id="caracteristica3" style="display: none;">Ajuste de control de ganancias</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/quadcast_1.png</span>
