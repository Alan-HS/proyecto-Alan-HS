...
<head>
    ...
    <title>Future Nostalgia</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/futurenostalgia_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Dua Lipa Future Nostalgia</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo álbum de Dua Lipa podrás tener una increíble experiencia de audio gracias a sus 12 canciones, además de tener una canción adicional que podrás disfrutar en este último lanzamiento.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Contiene 12 canciones</span>
            <span id="caracteristica2" style="display: none;">Audio de alta calidad</span>
            <span id="caracteristica3" style="display: none;">Contiene canción adicional</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/futurenostalgia_1.png</span>
