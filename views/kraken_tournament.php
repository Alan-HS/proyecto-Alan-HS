...
<head>
    ...
    <title>Kraken Tournament</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/tournament_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">RAZER KRAKEN TOURNAMENT EDITION</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo headset de Razer podrás tener un increíble sonido gracias a su sonido espacial THX, además de poder tener la capacidad de contar con conexión USB para tener comodidad en tú día a día y una excelente experiencia.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Audio espacial THX</span>
            <span id="caracteristica2" style="display: none;">Altavoces de 50 mm</span>
            <span id="caracteristica3" style="display: none;">Conexión USB</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/tournament_1.png</span>
