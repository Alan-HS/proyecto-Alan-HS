...
<head>
    ...
    <title>Photocard Jihyo</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/jihyo_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Jihyo Photocard</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con la nueva photocard de Jihyo podrás tener un increíble objeto de colección gracias a que es original y es importado desde corea del sur, además de ser pequeño y con buena calidad de materiales para que puedas tener una fotografía de ese artista que tanto adoras.
            </p>
            ...
            <span id="srcimg" style="display: none;">../images/jihyo_1.png</span>
