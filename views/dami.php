...
<head>
    ...
    <title>Photocard Dami</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/dami_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Dami Photocard</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con la nueva photocard de Dami podrás tener un increíble objeto de colección gracias a que es original y es importado desde corea del sur, además de ser pequeño, firmado por la artista y con buena calidad de materiales para que puedas tener una fotografía de ese artista que tanto adoras.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">55 x 85 mm</span>
            <span id="caracteristica2" style="display: none;">Firmada por la integrante</span>
            <span id="caracteristica3" style="display: none;">Beneficio de preventa</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/dami_1.png</span>
