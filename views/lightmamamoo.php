...
<head>
    ...
    <title>MAMAMOO Lightstick</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/lightmamamoo_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">MAMAMOO Lightstick</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo lightstick de MAMAMOO podrás tener una increíble experiencia en los conciertos gracias a su autonomía de batería, además de tener iluminación RGB con 4 modos de iluminación para poder apoyar a tu grupo favorito con estilo.
            </p>
            ...
            <span id="caracteristica2" style="display: none;">7 colores diferentes de iluminación</span>
            <span id="caracteristica3" style="display: none;">Contiene pegatina</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/lightmamamoo_1.png</span>
