...
<body>
    ...
    <?php
        ...
        if($_SESSION["type"] !== "normal") {//Si no es normal
            echo  "<form action=\"../controllers/headsetsController.php\" method=\"POST\" id=\"form-product\" class=\"form-container\" enctype=\"multipart/form-data\">
            <input type=\"hidden\" name=\"_method\" value=\"POST\">
            <input type=\"hidden\" name=\"_type\" value=\"headsets\">
