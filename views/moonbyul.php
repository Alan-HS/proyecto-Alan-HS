...
<head>
    ...
    <title>Photocard Moonbyul</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/moonbyul_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Moonbyul Photocard</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con la nueva photocard de Moonbyul podrás tener un increíble objeto de colección gracias a que es original y es importado desde corea del sur, además de ser pequeño y con buena calidad de materiales para que puedas tener una fotografía de ese artista que tanto adoras.
            </p>
            ...
            <span id="caracteristica2" style="display: none;">Importado de corea del sur</span>
            <span id="caracteristica3" style="display: none;">100% original</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/moonbyul_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">150</span> <!-- Cambiar esto a cada una -->
