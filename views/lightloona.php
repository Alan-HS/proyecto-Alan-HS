...
<head>
    ...
    <title>LOONA Lightstick</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/lightloona_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">LOONA Lightstick</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo lightstick de LOONA podrás tener una increíble experiencia en los conciertos gracias a su autonomía de batería, además de tener iluminación RGB con 4 modos de iluminación para poder apoyar a tu grupo favorito con estilo.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Iluminación RGB</span>
            <span id="caracteristica2" style="display: none;">4 modos de iluminación</span>
            <span id="caracteristica3" style="display: none;">Conexión Bluetooth</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/lightloona_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">1500</span> <!-- Cambiar esto a cada una -->
