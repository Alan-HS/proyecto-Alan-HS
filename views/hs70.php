...
<head>
    ...
    <title>HS70</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/hs70_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Corsair HS70</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo headset de Corsair podrás tener un increíble sonido gracias a su sonido envolvente 360°, además de poder tener la capacidad de contar con conexión USB, Bluetooth o por medio de cable 3,5 mm para tener comodidad en tú día a día y una excelente experiencia.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Conexión USB, Bluetooth o cable de 3,5 mm</span>
            <span id="caracteristica2" style="display: none;">Micrófono desmontable con cancelación de ruido</span>
            <span id="caracteristica3" style="display: none;">Audio envolvente 360°</span>
            <!-- Imagen que va a llevar --> <!-- Cambiar esto a cada una con el _1-->
            <span id="srcimg" style="display: none;">../images/hs70_1.png</span>
