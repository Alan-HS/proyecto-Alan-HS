...
<head>
    ...
    <title>Mercury - Act 1</title> <!-- Cambiar esto a cada una -->
</head>
<body>
    ...
    <div class="content">
        <div class="product-photo">
            <img class="img-producto" src="../images/mercury_2.png" alt="Producto"> <!-- Cambiar esto a cada una -->
        </div>
        <div class="product-info">
            <h1 id="name-product">Imagine Dragons Mercury - Act 1</h1> <!-- Cambiar esto a cada una -->
            <p class="product-text"> <!-- Cambiar esto a cada una -->
            Con el nuevo álbum de Imagine Dragons podrás tener una increíble experiencia de audio gracias a sus 14 canciones, además de tener un photobook para que puedas observar el detrás de cámaras de este último lanzamiento.
            </p>
            ...
            <span id="caracteristica1" style="display: none;">Contiene 14 canciones</span>
            <span id="caracteristica2" style="display: none;">Contiene poster</span>
            ...
            <span id="srcimg" style="display: none;">../images/mercury_1.png</span>

            <form action="#" id="price-add">
                <span id="price-text">250</span> <!-- Cambiar esto a cada una -->
