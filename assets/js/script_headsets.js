...
function getProducts() {
    ...
    xhttp.open("GET","../controllers/headsetsController.php",true);//Se le puso esto
...
function editProduct(id) {
    ...
    xhttp.open("GET","../controllers/headsetsController.php?id=" + id,true);//Se le cambia el nombre dependiendo de la categoria
