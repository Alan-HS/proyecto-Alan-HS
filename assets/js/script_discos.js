...
function getProducts() {
    ...
    xhttp.open("GET","../controllers/discosController.php",true);//Se le puso esto
...
function editProduct(id) {
    ...
    xhttp.open("GET","../controllers/discosController.php?id=" + id,true);//Se le cambia el nombre dependiendo de la categoria
