...
function getProducts() {
    ...
    xhttp.open("GET","../controllers/lightstickController.php",true);//Se le puso esto
...
function paintProducts(list) {
    ...
    for(var i = 0; i < list.length; i++) {
        html += 
            ...
            <a href="../views/${list[i].href}"><img class="img-product" src="../${list[i].image}" alt="Imagen producto lista"></a>
...
function editProduct(id) {
    ...
    xhttp.open("GET","../controllers/lightstickController.php?id=" + id,true);//Se le cambia el nombre dependiendo de la categoria
