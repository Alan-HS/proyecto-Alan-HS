...
function getProducts() {
    ...
    xhttp.open("GET","../controllers/microfonosController.php",true);//Se le puso esto
...
function editProduct(id) {
    ...
    xhttp.open("GET","../controllers/microfonosController.php?id=" + id,true);//Se le cambia el nombre dependiendo de la categoria
